...
describe('UtilisateurService', () => {
  ...
  it('should fetch all utilisateurs', () => {
    const mockUtilisateurs: Utilisateur[] = [
      { id: '1', nom: 'Test User 1' },
      { id: '2', nom: 'Test User 2' }
    ];
  ...
  it('should delete a utilisateur', () => {
    const mockUtilisateur: Utilisateur = { id: '1', nom: 'Test User' };
  ...
  it('should get antennes', () => {
    const mockAntennes: Antenne[] = [{ id: '1', nom: 'Antenna 1' }];
  ...
  it('should change default antenne', () => {
    const mockAntenne: Antenne = { id: '1', nom: 'Default Antenna' };
